...
class bookController {
  async addBook(req, res) {
    try {
      ...
      if (existingBook) {
        // fs.appendFile(
        //   "../server/print.log",
        //   `Duplicate book found before adding at ${new Date().getHours()}:${new Date().getMinutes()}:${new Date().getSeconds()} PM `
        // );
      ...
      if (result) {
        // fs.appendFile(
        //   "../server/print.log",
        //   `Book addition succeeded at ${new Date().getHours()}:${new Date().getMinutes()}:${new Date().getSeconds()} PM `
        // );
        return res.status(200).send(success("New book added", result));
      } else {
        // fs.appendFile(
        //   "../server/print.log",
        //   `Book addition unsuccessful at ${new Date().getHours()}:${new Date().getMinutes()}:${new Date().getSeconds()} PM `
        // );
      ...
      // fs.appendFile(
      //   "../server/print.log",
      //   `Book addition error at ${new Date().getHours()}:${new Date().getMinutes()}:${new Date().getSeconds()} PM `
      // );
  ...
  async updateBook(req, res) {
    try {
      ...
      // fs.appendFile(
      //   "../server/print.log",
      //   `Book info updated at ${new Date().getHours()}:${new Date().getMinutes()}:${new Date().getSeconds()} PM `
      // );
      return res
        .status(200)
        .send(success("Book information updated", updatedBook));
    } catch (error) {
      console.log("Book update error", error);
      // fs.appendFile(
      //   "../server/print.log",
      //   `Book update error at ${new Date().getHours()}:${new Date().getMinutes()}:${new Date().getSeconds()} PM `
      // );
      return res.status(500).send(success("Internal server error"));
    }
  }
  async deleteBook(req, res) {
    try {
      ...
      if (!book) {
        ...
        // fs.appendFile(
        //   "../server/print.log",
        //   `Book delete success at ${new Date().getHours()}:${new Date().getMinutes()}:${new Date().getSeconds()} PM `
        // );
        return res
          .status(200)
          .send(success(`${book.title} is deleted successfully`));
      }
    } catch (error) {
      console.log("Book update error", error);
      // fs.appendFile(
      //   "../server/print.log",
      //   `Book deletion error at ${new Date().getHours()}:${new Date().getMinutes()}:${new Date().getSeconds()} PM `
      // );
      return res.status(500).send(success("Internal server error"));
    }
  }
  async getBook(req, res) {
    try {
      ...
      if (stock && (stockFlow === "upper" || stockFlow === "lower")) {
        const stockFilter =
          stockFlow === "upper"
            ? { $gte: parseFloat(stock) }
            : { $lte: parseFloat(stock) };
      ...
      if (query.ratings) {
        if (rate && (rateFlow === "upper" || rateFlow === "lower")) {
          ...
          console.log(
            "2query.ratings.rate",
            query.ratings ? query.ratings.rate : null
          );
          query.ratings.rate = {
            $eq: parseFloat(rate),
          };
      ...
      if (order) {
        if (order === "asc") {
          ...
          return res
            .status(200)
            .send(success("priceOrder parameter is invalid"));
        }
      }
      ...
      if (books.length > 0) {
        ...
        // fs.appendFile(
        //   "../server/print.log",
        //   `Get book success at ${new Date().getHours()}:${new Date().getMinutes()}:${new Date().getSeconds()} PM `
        // );
      ...
      if (books.length == 0) {
        // fs.appendFile(
        //   "../server/print.log",
        //   `No book found at at ${new Date().getHours()}:${new Date().getMinutes()}:${new Date().getSeconds()} PM `
        // );
      ...
      // fs.appendFile(
      //   "../server/print.log",
      //   `Get book error at ${new Date().getHours()}:${new Date().getMinutes()}:${new Date().getSeconds()} PM `
      // );
      return res.status(500).send(success("Internal server error"));
    }
  }
  ...
  async addReview(req, res) {
    try {
      ...
      // fs.appendFile(
      //   "../server/print.log",
      //   `Review addition success at ${new Date().getHours()}:${new Date().getMinutes()}:${new Date().getSeconds()} PM `
      // );
      return res
        .status(200)
      ...
      // fs.appendFile(
      //   "../server/print.log",
      //   `Add review error at ${new Date().getHours()}:${new Date().getMinutes()}:${new Date().getSeconds()} PM `
      // );
      return res.status(500).send(success("Internal server error"));
    }
  }
  async updateReview(req, res) {
    try {
      ...
      if (!existingReview) {
        // fs.appendFile(
        //   "../server/print.log",
        //   `No review found to update  at ${new Date().getHours()}:${new Date().getMinutes()}:${new Date().getSeconds()} PM `
        // );
      ...
      // fs.appendFile(
      //   "../server/print.log",
      //   `Review update failed at ${new Date().getHours()}:${new Date().getMinutes()}:${new Date().getSeconds()} PM `
      // );
      return res.status(500).send(success("Internal server error"));
    }
  }
  async deleteReview(req, res) {
    try {
      ...
      const result2 = await reviewModel.findOne({
        bookId,
        userId: userIdAsString,
      });
      const result21 = await reviewModel.findOneAndDelete({
        bookId,
        userId: userIdAsString,
      });
      ...
      if (!result2) {
        // fs.appendFile(
        //   "../server/print.log",
        //   `No review found for delete at ${new Date().getHours()}:${new Date().getMinutes()}:${new Date().getSeconds()} PM `
        // );
        ...
        // fs.appendFile(
        //   "../server/print.log",
        //   `Review delete success at ${new Date().getHours()}:${new Date().getMinutes()}:${new Date().getSeconds()} PM `
        // );
      ...
      // fs.appendFile(
      //   "../server/print.log",
      //   `Review delete error at ${new Date().getHours()}:${new Date().getMinutes()}:${new Date().getSeconds()} PM `
      // );
  ...
  async addRate(req, res) {
    try {
      ...
      if (!user) {
        // fs.appendFile(
        //   "../server/print.log",
        //   `User not found for rate add at ${new Date().getHours()}:${new Date().getMinutes()}:${new Date().getSeconds()} PM `
        // );
        return res.status(404).json({ error: "User is not found" });
      }
      ...
      if (existingRate) {
        // fs.appendFile(
        //   "../server/print.log",
        //   `Cant add more than one rate at ${new Date().getHours()}:${new Date().getMinutes()}:${new Date().getSeconds()} PM `
        // );
        return res
          .status(400)
          .json({ error: "You have already provided a rate for this book." });
      }
      ...
      // fs.appendFile(
      //   "../server/print.log",
      //   `Rate addition succeeded at ${new Date().getHours()}:${new Date().getMinutes()}:${new Date().getSeconds()} PM `
      // );
      return res
        .status(200)
      ...
      // fs.appendFile(
      //   "../server/print.log",
      //   `Rate addition failed at ${new Date().getHours()}:${new Date().getMinutes()}:${new Date().getSeconds()} PM `
      // );
      return res.status(500).json({ error: "Internal server error" });
    }
  }
  async updateRate(req, res) {
    try {
      ...
      if (!existingRate) {
        // fs.appendFile(
        //   "../server/print.log",
        //   `No rate found to update at ${new Date().getHours()}:${new Date().getMinutes()}:${new Date().getSeconds()} PM `
        // );
      ...
      // fs.appendFile(
      //   "../server/print.log",
      //   `Rte update succeeded at ${new Date().getHours()}:${new Date().getMinutes()}:${new Date().getSeconds()} PM `
      // );
      return res
        .status(200)
      ...
      // fs.appendFile(
      //   "../server/print.log",
      //   `Rate update error at ${new Date().getHours()}:${new Date().getMinutes()}:${new Date().getSeconds()} PM `
      // );
      return res.status(500).json({ error: "Internal server error" });
    }
  }
  async deleteRate(req, res) {
    try {
      ...
      console.log("decodedToken", decodedToken);
      const userIdAsString = user._id.toString();
      const result2 = await rateModel.findOne({
        bookId,
        userId: userIdAsString,
      });
      const result21 = await rateModel.findOneAndDelete({
        bookId,
        userId: userIdAsString,
      });
      console.log("result2", result2);
      ...
      if (!result2) {
        // fs.appendFile(
        //   "../server/print.log",
        //   `no rate found to delete at ${new Date().getHours()}:${new Date().getMinutes()}:${new Date().getSeconds()} PM `
        // );
        ...
        // fs.appendFile(
        //   "../server/print.log",
        //   `Rate deletion succeeded at ${new Date().getHours()}:${new Date().getMinutes()}:${new Date().getSeconds()} PM `
        // );
        // console.log("result1",result1,"bookId",bookId,'userId',user._id)
      ...
      // fs.appendFile(
      //   "../server/print.log",
      //   `Rate deletion error at ${new Date().getHours()}:${new Date().getMinutes()}:${new Date().getSeconds()} PM `
      // );
      return res.status(500).json({ error: "Internal server error" });
    }
  }
